                        ...
                        <div className='flex flex-col justify-between items-start h-full px-0 lg:px-4 mt-2 lg:mt-20'>
                            ...
                            <div className='flex-1 flex flex-col gap-2'>
                                <div className='flex justify-start items-center gap-2'>
                                    ...
                                    <h3 className='text-2xl font-medium'>Sahil Gupta</h3>
                                </div>

                                <div className='flex justify-start items-center gap-2'>
                                    <FaLocationDot className='text-3xl text-[#00df72]' />
                                    <h3 className='text-xl'>Jamshedpur, India</h3>
                                </div>

                                <div className='flex justify-start items-center gap-2'>
                                    <IoCall className='text-3xl text-[#00df72]' />
                                    <h3 className='text-xl'>+91 6207295386</h3>
                                </div>
                                ...
                                <div className='flex justify-start items-center gap-2'>
                                    ...
                                    <h3 className='text-xl'>sahilguptahm@gmail.com</h3>
                                </div>
                            </div>
